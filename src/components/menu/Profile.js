          ...
          <div className='p-4 sm:ml-64'>
              <div className='md:w-3/4 mx-auto shadow-xl rounded-2xl pb-2 bg-white'>
                <div className='container horizontal mt-20'>
                  <div className='flex flex-col items-center dark:bg-gray-900 dark:text-gray-100'>
                    <img
                      src={user}
                      alt="Foto de perfil"
                    ...
                    <div className='space-y-4 text-center divide-y divide-gray-700'>
                      <div className='my-2 space-y-1'>
                        <h2 className="text-xl font-semibold mb-2 sm:text-2xl">Angelo Sanchez</h2>
                        <p className="px-5 text-xs sm:text-base dark:text-gray-400">Estudiante Bootcamp ESPOL</p>
                      </div>
